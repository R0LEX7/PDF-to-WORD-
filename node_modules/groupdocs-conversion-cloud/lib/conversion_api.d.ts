...
export declare class FileApi {
     ...
     * @param requestObj contains request parameters
     */
    copyFile(requestObj: model.CopyFileRequest): Promise<request.Response>;
    /**
     * Delete file
     * @param requestObj contains request parameters
     */
    deleteFile(requestObj: model.DeleteFileRequest): Promise<request.Response>;
    /**
     * Download file
     * @param requestObj contains request parameters
     */
     ...
     * @param requestObj contains request parameters
     */
    moveFile(requestObj: model.MoveFileRequest): Promise<request.Response>;
    /**
     * Upload file
     * @param requestObj contains request parameters
     */
...
export declare class FolderApi {
     ...
     * @param requestObj contains request parameters
     */
    copyFolder(requestObj: model.CopyFolderRequest): Promise<request.Response>;
    /**
     * Create the folder
     * @param requestObj contains request parameters
     */
    createFolder(requestObj: model.CreateFolderRequest): Promise<request.Response>;
    /**
     * Delete folder
     * @param requestObj contains request parameters
     */
    deleteFolder(requestObj: model.DeleteFolderRequest): Promise<request.Response>;
    /**
     ...
     * @param requestObj contains request parameters
     */
    moveFolder(requestObj: model.MoveFolderRequest): Promise<request.Response>;
}
/**
 * GroupDocs.Conversion Cloud API
 */
